...
(3 SDK retries x 3 nexai retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = os.path.join(os.path.expanduser("~"), ".nexai")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, nexai, ...) behind one endpoint.  A 429 can mean either:
