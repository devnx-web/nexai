"""
Skills configuration for nexai Agent.
`nexai skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.nexai/config.yaml under:
...
from nexai_cli.config import cfg_get, load_config, save_config
from nexai_cli.colors import Colors, color
from nexai_cli.platforms import PLATFORMS as _PLATFORMS
