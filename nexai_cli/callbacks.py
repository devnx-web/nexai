...
into prompt_toolkit's event loop. Each function takes the nexaiCLI instance
...
from nexai_cli.banner import cprint, _DIM, _RST
...
def prompt_for_secret(cli, var_name: str, prompt: str, metadata=None) -> dict:
    ...
    The secret is stored in ~/.nexai/.env and never exposed to the model.
    """
