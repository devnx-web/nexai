...
Usage:
    nexai pairing list              # Show all pending + approved users
    nexai pairing approve <platform> <code>  # Approve a pairing code
    nexai pairing revoke <platform> <user_id> # Revoke user access
    nexai pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle nexai pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: nexai pairing {list|approve|revoke|clear-pending}")
        print("Run 'nexai pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.nexai/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'nexai pairing list' to see pending codes.\n")
