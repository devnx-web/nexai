...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), NexAi Agent
license: MIT
...
The script reads `~/.nexai/.env` for two optional defaults:
...
Helper script: `~/.nexai/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.nexai/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.nexai/.env`.
...
```bash
python3 ~/.nexai/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.nexai/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
