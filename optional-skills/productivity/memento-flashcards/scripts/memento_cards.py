...
Data file: $NEXAI_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_NEXAI_HOME = Path(os.environ.get("NEXAI_HOME", Path.home() / ".nexai"))
DATA_DIR = _NEXAI_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
