---
name: nexai-atropos-environments
description: Build, test, and debug NexAi Agent RL environments for Atropos training. Covers the NexAiAgentBaseEnv interface, reward functions, agent loop integration, evaluation with tools, wandb logging, and the three CLI modes (serve/process/evaluate). Use when creating, reviewing, or fixing RL environments in the NexAi-agent repo.
version: 1.1.0
author: NexAi Agent
license: MIT
