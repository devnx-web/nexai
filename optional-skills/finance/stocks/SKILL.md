...
version: 0.1.0
author: Mibay (Mibayy), NexAi Agent
license: MIT
...
```
SCRIPT=~/.nexai/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.nexai/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
