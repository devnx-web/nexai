...
~/.nexai/channel_directory.json.  The send_message tool reads this file for
...
DIRECTORY_PATH = get_nexai_home() / "channel_directory.json"
...
def _build_from_sessions(platform_name: str) -> List[Dict[str, str]]:
    ...
    sessions_path = get_nexai_home() / "sessions" / "sessions.json"
