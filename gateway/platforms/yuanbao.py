...
try:
    ...
    _NEXAI_VERSION = "0.0.0"

_APP_VERSION = _NEXAI_VERSION
_BOT_VERSION = _NEXAI_VERSION
_YUANBAO_INSTANCE_ID = str(NEXAI_INSTANCE_ID)  # single source: yuanbao_proto.NEXAI_INSTANCE_ID
