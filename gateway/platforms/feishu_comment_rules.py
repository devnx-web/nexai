...
Config: ~/.nexai/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.nexai/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_nexai_home()`` helper (NEXAI_HOME-aware and
...
RULES_FILE = get_nexai_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_nexai_home() / "feishu_comment_pairing.json"
