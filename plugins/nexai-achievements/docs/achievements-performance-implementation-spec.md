# NexAi Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.nexai/plugins/nexai-achievements/state.json` (existing unlock state)
  - `~/.nexai/plugins/nexai-achievements/scan_snapshot.json` (new)
  - `~/.nexai/plugins/nexai-achievements/scan_checkpoint.json` (new)
