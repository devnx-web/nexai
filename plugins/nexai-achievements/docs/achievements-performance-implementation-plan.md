# NexAi Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.nexai/plugins/nexai-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.nexai/plugins/nexai-achievements/scan_checkpoint.json`.
