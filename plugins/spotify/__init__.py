...
``_check_spotify_available()`` — when the user has not run ``nexai auth
spotify``, the tools remain registered (so they appear in ``nexai
...
The Spotify auth flow (``nexai auth spotify``), CLI plumbing, and docs
