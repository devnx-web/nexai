...
- **Dataset (ours):** [DevNX/openthoughts-tblite](https://huggingface.co/datasets/DevNX/openthoughts-tblite)
- **Docker images:** `devnx/tblite-<task-name>:latest` on Docker Hub (100 images)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `DevNX/terminal-bench-2`  | `DevNX/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
