"""
Monkey patches for making nexai-agent tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by nexai_base_env.py).
