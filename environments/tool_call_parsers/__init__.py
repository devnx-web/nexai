...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("nexai")
        class nexaiToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "nexai", "mistral", "llama3_json")
...
from environments.tool_call_parsers.nexai_parser import nexaiToolCallParser  # noqa: E402, F401
