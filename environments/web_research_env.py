...
Inspired by: GroceryMind — production nexai agent doing live web research
             across German grocery stores (firecrawl + nexai-agent)
"""
...
# Ensure nexai-agent root is on path
...
class WebResearchEnvConfig(nexaiAgentEnvConfig):
...
class WebResearchEnv(nexaiAgentBaseEnv):
    """
