...
Reports live under ``~/.nexai/logs/curator/{YYYYMMDD-HHMMSS}/`` alongside
...
def curator_env(tmp_path, monkeypatch):
    """Isolated NEXAI_HOME with a skills/ dir + reset curator module state."""
    home = tmp_path / ".nexai"
    home.mkdir()
    (home / "skills").mkdir()
    (home / "logs").mkdir()
...
def curator_env_with_cron(curator_env, monkeypatch):
    ...
    monkeypatch.setattr(jobs_mod, "NEXAI_DIR", home)
