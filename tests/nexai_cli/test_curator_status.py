"""Tests for `nexai curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import nexai_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated NEXAI_HOME with real agent-created skills on disk."""
    home = tmp_path / ".nexai"
    skills = home / "skills"
    ...
    from nexai_cli import curator as curator_cli
