"""Tests for the specifier module + `nexai kanban specify` CLI surface.
...
from nexai_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `nexai kanban …` argparse surface directly."""
