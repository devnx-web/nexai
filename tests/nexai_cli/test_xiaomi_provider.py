...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from nexai_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in NEXAI_OVERLAYS
        overlay = NEXAI_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify nexai doctor recognizes Xiaomi env vars."""
