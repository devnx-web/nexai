...
The main() function in nexai_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `nexai -c model`
...
def _build_parser():
    """Build a minimal replica of the nexai top-level parser."""
