"""Tests for the interactive session browser (`nexai sessions browse`).
...
from nexai_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """nexai sessions browse should be parseable."""
        from nexai_cli.main import main as _main_entry
