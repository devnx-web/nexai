...
See: https://github.com/NousResearch/nexai-agent/issues/4426
"""
...
class TestGetSubprocessHome:
    """Unit tests for nexai_constants.get_subprocess_home()."""

    def test_returns_none_when_nexai_home_unset(self, monkeypatch):
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("NEXAI_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("NEXAI_HOME", str(base / "beta"))
...
class TestMakeRunEnvHomeInjection:
    ...
    def test_injects_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        assert result["HOME"] == str(nexai_home / "home")
    ...
    def test_no_injection_when_nexai_home_unset(self, monkeypatch):
        monkeypatch.delenv("NEXAI_HOME", raising=False)
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from nexai_cli.profiles import _PROFILE_DIRS
