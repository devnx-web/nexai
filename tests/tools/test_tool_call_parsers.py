...
class TestParserRegistry:
    ...
    def test_nexai_parser_registered(self):
        parsers = list_parsers()
        assert "nexai" in parsers
...
class TestnexaiParser:
    @pytest.fixture
    def parser(self):
        return get_parser("nexai")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["nexai"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use nexai format since that's universal
