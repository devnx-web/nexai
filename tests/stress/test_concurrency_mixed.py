...
def worker_loop(worker_id: int, nexai_home: str, result_file: str) -> None:
...
def reclaimer_loop(nexai_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="nexai_mixed_stress_")
    print(f"NEXAI_HOME = {home}")
