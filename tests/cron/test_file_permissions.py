...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("nexai_cli.config.get_config_path", return_value=config_path), \
             patch("nexai_cli.config.ensure_nexai_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("nexai_cli.config.get_env_path", return_value=env_path), \
             patch("nexai_cli.config.ensure_nexai_home"):
    ...
    def test_ensure_nexai_home_sets_0700(self):
        home = Path(self.tmpdir) / ".nexai"
        with patch("nexai_cli.config.get_nexai_home", return_value=home):
