...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "devnx.com"
...
def auth_json_path():
    """Return the nexai auth store path, respecting NEXAI_HOME overrides."""
    return get_nexai_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from nexai_cli.auth import resolve_nous_access_token
