...
Trust levels:
  - builtin:   Ships with nexai. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.nexai/\.env|\~/\.nexai/\.env',
     "nexai_env_access", "critical", "exfiltration",
     "directly references nexai secrets file"),
    ...
    (r'\.nexai/config\.yaml|\.nexai/SOUL\.md',
     "nexai_config_mod", "critical", "persistence",
     "references nexai configuration files directly"),
