# Streaming LLM Response Support for NexAi Agent
...
```
NEXAI_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("NEXAI_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `nexai_cli/config.py` | 1 | +streaming config defaults |
