...
const STORAGE_KEY = "nexai-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `nexai_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "nexai-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-nexai-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-nexai-theme-font", "true");
