 ...
 * `window.__NEXAI_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the nexai brand in the top bar
 ...
 *  `window.__NEXAI_PLUGINS__.registerSlot(...)`.
 *
