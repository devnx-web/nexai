...
Built for [NexAi Agent](https://github.com/NousResearch/nexai-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/nexai-agent/skills/creative/ascii-video`](https://github.com/NousResearch/nexai-agent/tree/main/skills/creative/ascii-video) via PR.
