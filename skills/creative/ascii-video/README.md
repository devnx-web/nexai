...
Built for [NexAi Agent](https://github.com/DevNX/nexai-agent). Usable in any coding agent. Canonical source lives here; synced to [`DevNX/nexai-agent/skills/creative/ascii-video`](https://github.com/DevNX/nexai-agent/tree/main/skills/creative/ascii-video) via PR.
