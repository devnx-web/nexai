...
| | |
|---|---|
| Source | Optional — install with `nexai skills install official/research/qmd` |
...
NexAi Agent via the native MCP client. This is the preferred
...
Then configure NexAi Agent to connect via HTTP:
