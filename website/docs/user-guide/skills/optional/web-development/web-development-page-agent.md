...
- User wants **nexai itself to drive a browser** → use nexai' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
