...
| | |
|---|---|
| Source | Optional — install with `nexai skills install official/mlops/stable-diffusion` |
...
- **[Advanced Usage](https://github.com/NousResearch/nexai-agent/blob/main/optional-skills/mlops/stable-diffusion/references/advanced-usage.md)** - Custom pipelines, fine-tuning, deployment
- **[Troubleshooting](https://github.com/NousResearch/nexai-agent/blob/main/optional-skills/mlops/stable-diffusion/references/troubleshooting.md)** - Common issues and solutions
