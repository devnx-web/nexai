...
| | |
|---|---|
| Source | Optional — install with `nexai skills install official/health/neuroskill-bci` |
...
Connect nexai to a running [NeuroSkill](https://neuroskill.com/) instance to read
