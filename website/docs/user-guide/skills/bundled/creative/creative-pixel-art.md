...
```python
import sys
sys.path.insert(0, "/home/teknium/.nexai/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.nexai/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — nexai installs package this)
