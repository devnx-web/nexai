...
```bash
python3 -m pyfiglet "NexAi" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=nexai&font=Slant" | boxes -d stone
```
