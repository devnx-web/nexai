...
| Version | `1.1.0` |
| Author | NexAi Agent (adapted from obra/superpowers) |
| License | MIT |
...
> **For nexai:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use nexai tools to understand the project:
