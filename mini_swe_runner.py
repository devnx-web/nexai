#!/usr/bin/env python3
"""
SWE Runner with nexai Trajectory Format

A runner that uses nexai-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the nexai-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses nexai-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in nexai format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches nexai-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using nexai-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with nexai Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses nexai-Agent's built-in execution environments
    and outputs trajectories in nexai-Agent format.
    """
    ...
    def _convert_to_nexai_format(
        ...
        """
        Convert internal message format to nexai trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to nexai trajectory format
        trajectory = self._convert_to_nexai_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with nexai trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with nexai Trajectory Format")
    print("=" * 60)
