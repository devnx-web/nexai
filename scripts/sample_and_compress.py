...
DEFAULT_DATASETS = [
    ...
    "NousResearch/nexai-agent-megascience-sft1",
    "NousResearch/nexai-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/nexai-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-nexai-agent"
]
