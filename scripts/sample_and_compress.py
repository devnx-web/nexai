...
DEFAULT_DATASETS = [
    "DevNX/swe-terminus-agent-glm-kimi-minimax",
    "DevNX/nexai-agent-megascience-sft1",
    "DevNX/nexai-Agent-Thinking-GLM-4.7-SFT2",
    "DevNX/nexai-Agent-Thinking-GLM-4.7-SFT1",
    "DevNX/terminal-tasks-glm-nexai-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "DevNX/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload DevNX/{output_name} {final_output}")
