...
# Configuration
REPO_URL_SSH="git@github.com:NousResearch/nexai-agent.git"
REPO_URL_HTTPS="https://github.com/NousResearch/nexai-agent.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  irm https://raw.githubusercontent.com/NousResearch/nexai-agent/main/scripts/install.ps1 | iex"
            exit 1
            ;;
        *)
            OS="unknown"
