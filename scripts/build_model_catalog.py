#!/usr/bin/env python3
"""Build the nexai Model Catalog — a centralized JSON manifest of curated models.
...
nexai CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a nexai release.
...
# Ensure NEXAI_HOME is set for imports that touch it at module level.
os.environ.setdefault("NEXAI_HOME", os.path.join(os.path.expanduser("~"), ".nexai"))

from nexai_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "nexai-agent repo",
            "docs": "https://nexai-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
