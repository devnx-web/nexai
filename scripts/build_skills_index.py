#!/usr/bin/env python3
"""Build the nexai Skills Index — a centralized JSON catalog of all skills.
...
`nexai skills search/install` can use it without hitting the GitHub API.
...
# Ensure NEXAI_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building nexai Skills Index...", flush=True)
