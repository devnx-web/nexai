...
import type { ScrollBoxHandle } from '@nexai/ink'
import { evictInkCaches } from '@nexai/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.NEXAI_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
